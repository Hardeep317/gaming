...
const BentoTilt = ({children, className = ''}) => {
    ...
    return (
        <div className={className} onMouseMove={handleMouseMove} ref={itemRef} onMouseLeave={handleMouseLeave} style={{ transform: transformStyle  }}>
            {children}
        </div>
    )
}
    ...
    <section className='bg-black pb-52'>
       <div className="container mx-auto px-3 md:px-10">
            <div className='px-5 py-32'>
                <p className='font-circular-web text-lg text-blue-50'>Into the Metagamr Layer</p>
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <BentoTilt className="bento-tilt_2 ">
                        <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                            <h1 className="bento-title special-font max-w-64 text-black"><b>M</b>ore to c<b>o</b>ming so<b>o</b>n</h1>
